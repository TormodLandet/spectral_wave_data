...
def write_amp2_swd(filename, n_swd, dk, nsteps, dt,
                   h_list, ht_list, c_list, ct_list,
                   depth=None, grav=GRAV):
    """
...
def airy_deep_water_swd(tmp_path_factory):
    ...
    nsteps, dt = 8, 0.5
    h_list, ht_list, c_list, ct_list, omega, k1 = \
        _airy_coefficients(n_swd, dk, A, nsteps, dt, depth=None)
...
def airy_finite_depth_swd(tmp_path_factory):
    ...
    nsteps, dt = 8, 0.5
    h_list, ht_list, c_list, ct_list, omega, k1 = \
        _airy_coefficients(n_swd, dk, A, nsteps, dt, depth=depth)
    write_amp2_swd(fname, n_swd, dk, nsteps, dt,
                   h_list, ht_list, c_list, ct_list, depth=depth)
